...
namespace Microsoft.Azure.Management.Network
{
    ...
    internal partial class VirtualRouterPeeringsOperations : IServiceOperations<NetworkManagementClient>, IVirtualRouterPeeringsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<VirtualRouterPeering>>> ListByResourceGroupNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
